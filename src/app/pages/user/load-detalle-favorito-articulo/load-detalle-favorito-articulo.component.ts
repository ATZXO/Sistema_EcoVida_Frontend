...
@Component({
  selector: 'app-load-detalle-favorito-articulo',
  standalone: false,
  templateUrl: './load-detalle-favorito-articulo.component.html',
  styleUrl: './load-detalle-favorito-articulo.component.css'
})
export class LoadDetalleFavoritoArticuloComponent implements OnInit {
  ...
  volverALista(): void {
    this.router.navigate(['/user-dashboard/articulos-favorito-user']);
  }
