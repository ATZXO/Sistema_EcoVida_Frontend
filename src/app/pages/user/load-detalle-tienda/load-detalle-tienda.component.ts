...
@Component({
  selector: 'app-load-detalle-tienda',
  standalone: false,
  templateUrl: './load-detalle-tienda.component.html',
  styleUrl: './load-detalle-tienda.component.css'
})
export class LoadDetalleTiendaComponent implements OnInit {
  ...
  volverALista(): void {
    this.router.navigate(['/user-dashboard/tiendas-user']);
  }
