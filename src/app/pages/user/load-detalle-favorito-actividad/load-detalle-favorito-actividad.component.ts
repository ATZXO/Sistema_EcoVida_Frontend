...
@Component({
  selector: 'app-load-detalle-favorito-actividad',
  standalone: false,
  templateUrl: './load-detalle-favorito-actividad.component.html',
  styleUrl: './load-detalle-favorito-actividad.component.css'
})
export class LoadDetalleFavoritoActividadComponent implements OnInit {
  ...
  volverALista(): void {
    this.router.navigate(['/user-dashboard/actividades-favorito-user']);
  }
