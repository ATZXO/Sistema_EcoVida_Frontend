...
@Component({
  selector: 'app-load-detalle-favorito-tienda',
  standalone: false,
  templateUrl: './load-detalle-favorito-tienda.component.html',
  styleUrl: './load-detalle-favorito-tienda.component.css'
})
export class LoadDetalleFavoritoTiendaComponent implements OnInit {
  ...
  verificarSiEsFavorito(): void {
    this.tiendaService.esFavorito(this.user.id, this.id).subscribe(
      resultado => {
  ...
  toggleFavorito(): void {
    ...
    if (this.esFavorito) {
      this.tiendaService.eliminarFavorito(this.user.id, this.id).subscribe(
        () => {
          this.esFavorito = false;
        }
      );
    } else {
      this.tiendaService.agregarFavorito(this.user.id, this.id).subscribe(
        () => {
  ...
  volverALista(): void {
    this.router.navigate(['/user-dashboard/tiendas-favorito-user']);
  }
